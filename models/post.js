 ...
 */
const getPostsConditions = require("../utilities/postCOndition")
module.exports.getAfroswaggerPosts = function (
  CLIENT,
  req,
  res,
  posted_for,
...
module.exports.getUserPosts = function (CLIENT, req, res, user_id, isShow, cb) {
  let CONNECTION = CLIENT.db(utility.dbName);
  let postCollection = CONNECTION.collection(Model.collection_name);
...
module.exports.addPost = function (CLIENT, req, res, cb) {
  let CONNECTION = CLIENT.db(utility.dbName);
  let postCollection = CONNECTION.collection(Model.collection_name);
                  ...
                  postCollection
                    ...
                    .then((postDetails) => {
                      ...
                      userCollection
                        ...
                        .then((userDetails) => {
                          if (userDetails.user_id != validatedData.posted_by) {
                            var userNameET = "";
                            var userNameEF = "";
                        ...
                        await userCollection
                          ...
                          .then((Details) => {
                            ...
                            notify_users[0].forEach((user) => {
                              userCollection
                                .findOne({
                                  $or: [{ user_id: user }, { user_name: user }],
                                })
                                .then((userDetails) => {
                                  console.log("userDetails.findOne lol ")
                                  if (
...
// used for graphql export
module.exports.sharedPostLookup = sharedPostLookup;

module.exports.getComments = getComments;
module.exports.getRequestedUsers = getRequestedUsers;
module.exports.postedByUserLookupFunc = postedByUserLookupFunc;
module.exports.likesLookup = likesLookup;
module.exports.likedByMeLookup = likedByMeLookup;
module.exports.postProjection = postProjection;

module.exports.shuffle = shuffle;
module.exports.userCollectionName = userCollectionName;
module.exports.getAddressFromLatLong = getAddressFromLatLong;
