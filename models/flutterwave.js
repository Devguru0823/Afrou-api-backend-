...
const FlutterWavePayment = require('./v2/FlutterWavePayment.model');
const { createHistory } = require('./v2/history');
const { addUser } = require('./user');
const userModel = require('./user.json');
const utility = require('../utilities');
const Card = require('./v2/Card.model');
...
module.exports.createFlutterwavePayment = asyncHandler(
	async (req, res, next) => {
		...
		const payload = {
			...
			amount: `${amount}`,
			currency,
			redirect_url: 'https://staging.afrocamgist.com/ehealth/verify',
			customer: {
				email,
